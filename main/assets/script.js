...
const ColumnUI = {
  ...
  move(button, e, [doMoveRight]) {
    ...
    App.saveBoards(App.data.boards, App.data.currentBoardId);
    BoardUI.renderBoard();
    this.toggleMoveUi(document.querySelector('[data-id="' + moveColId + '"]'), null, [false]);
...
const Events = {
  ...
  map: {
    ...
    'input': {
      ...
      '.column-menu input[name="skipMove"]': 'RanksUI.setSkipMove',
    },
    'contextmenu': {
